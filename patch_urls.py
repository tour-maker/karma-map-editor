...
with open('src/services/googleSheets.js', 'r') as f:
    code = f.read()
code = re.sub(r"const APPS_SCRIPT_URL = import\.meta\.env\.VITE_GOOGLE_SHEETS_SCRIPT_URL \|\| '';", f"const APPS_SCRIPT_URL = import.meta.env.VITE_GOOGLE_SHEETS_SCRIPT_URL || {old_url};", code)
...
with open('src/components/GoogleSheetsConnect.jsx', 'r') as f:
    code = f.read()
code = re.sub(r"const DEFAULT_SCRIPT_URL = import\.meta\.env\.VITE_GOOGLE_SHEETS_SCRIPT_URL \|\| '';", f"const DEFAULT_SCRIPT_URL = import.meta.env.VITE_GOOGLE_SHEETS_SCRIPT_URL || {old_url};", code)
